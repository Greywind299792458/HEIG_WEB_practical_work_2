...
<body>
    ...
    <main>
        <section id="main-section" class="center centered-info">
            <p>Oops ! Vous n'étiez pas sensé arriver ici!</p>
            <iframe src="https://giphy.com/embed/RPdLHpiOnL2pO" width="480" height="269" frameBorder="0" class="giphy-embed" allowFullScreen>
            </iframe>
        </section>
    </main>
</body>
